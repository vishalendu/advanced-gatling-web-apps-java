...
public class TestPopulation {
    ...
    private static final int USER_COUNT = Integer.parseInt(System.getenv("USERS", "5"));
    private static final Duration RAMP_DURATION = Duration.ofSeconds(Integer.parseInt(System.getenv("RAMP_DURATION", "10")));
